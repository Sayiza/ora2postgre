...
public class AqRecipientsConverterTest {
    ...
    public void testRecipientsColumnAnalysisIntegration() {
        ...
        com.sayiza.oracle2postgre.global.Everything mockEverything = mock(com.sayiza.oracle2postgre.global.Everything.class);
    ...
    public void testPostgreSQLTypeMapping() {
        ...
        assertEquals("jsonb", com.sayiza.oracle2postgre.plsql.ast.tools.TypeConverter.toPostgre("aq$_recipients"));
        assertEquals("jsonb", com.sayiza.oracle2postgre.plsql.ast.tools.TypeConverter.toPostgre("AQ$_RECIPIENTS"));
        assertEquals("jsonb", com.sayiza.oracle2postgre.plsql.ast.tools.TypeConverter.toPostgre("sys.aq$_recipients"));
        assertEquals("jsonb", com.sayiza.oracle2postgre.plsql.ast.tools.TypeConverter.toPostgre("SYS.AQ$_RECIPIENTS"));
        
        // Verify other AQ types still work correctly
        assertEquals("jsonb", com.sayiza.oracle2postgre.plsql.ast.tools.TypeConverter.toPostgre("aq$_jms_text_message"));
        assertEquals("jsonb", com.sayiza.oracle2postgre.plsql.ast.tools.TypeConverter.toPostgre("aq$_sig_prop"));
        assertEquals("text", com.sayiza.oracle2postgre.plsql.ast.tools.TypeConverter.toPostgre("varchar2"));
    }
