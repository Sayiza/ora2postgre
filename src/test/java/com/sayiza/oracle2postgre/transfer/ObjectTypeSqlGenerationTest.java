...
public class ObjectTypeSqlGenerationTest {
    ...
    void testIdentifierQuoting() throws Exception {
        ...
        assertEquals("NR", com.sayiza.oracle2postgre.global.PostgreSqlIdentifierUtils.quoteIdentifier("NR"));
        assertEquals("\"TEXT\"", com.sayiza.oracle2postgre.global.PostgreSqlIdentifierUtils.quoteIdentifier("TEXT"));
        assertEquals("LANGY", com.sayiza.oracle2postgre.global.PostgreSqlIdentifierUtils.quoteIdentifier("LANGY"));
        ...
        assertNull(com.sayiza.oracle2postgre.global.PostgreSqlIdentifierUtils.quoteIdentifier(null));
    }
}