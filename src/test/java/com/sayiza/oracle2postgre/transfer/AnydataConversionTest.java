...
public class AnydataConversionTest {
    ...
    public void testPostgreSQLTypeMapping() {
        ...
        assertEquals("jsonb", com.sayiza.oracle2postgre.plsql.ast.tools.TypeConverter.toPostgre("anydata"));
        assertEquals("jsonb", com.sayiza.oracle2postgre.plsql.ast.tools.TypeConverter.toPostgre("ANYDATA"));
        
        // Verify other types still work correctly
        assertEquals("text", com.sayiza.oracle2postgre.plsql.ast.tools.TypeConverter.toPostgre("dburitype"));
