...
public class OracleFunctionMapper {
  ...
  public static String getMappingIfIs2BeApplied(String what) {
    String mapped = SIMPLE_FUNCTION_MAPPINGS.get(what.toUpperCase());
    if (mapped != null && !mapped.equals(what.toUpperCase())) {
      return mapped;
    }
